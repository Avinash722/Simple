...
public class TestCase4 {
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("(//button[contains(text(),'Add Customer')])[2]")).click();
        ...
        boolean isCustomerDisplayed = driver.findElements(By.xpath("//td[contains(text(),'John')]")).size() == 1;
